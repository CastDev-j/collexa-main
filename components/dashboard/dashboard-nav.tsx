...
import { LayoutDashboard, Package, Heart, Users, Settings, LogOut } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-8">
            <Link href="/" className="font-bold text-xl text-primary hover:text-orange-600 transition-colors">
              Collexa
            </Link>
        ...
        <div className="max-w-6xl mx-auto">
          <ul className="grid grid-cols-5">
            {navItems.map((item) => {
              ...
              return (
                <li key={item.href}>
                  <Link href={item.href} className={cn('flex flex-col items-center justify-center py-2 text-xs text-slate-600', isActive && 'text-slate-900')}
                  >
